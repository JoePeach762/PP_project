...
const file_meals_api_meals_proto_rawDesc = "" +
	"\n" +
	"\x15meals_api/meals.proto\x12\x10meals.service.v1\x1a\x17models/meal_model.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\"`\n" +
