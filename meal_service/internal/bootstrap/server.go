...
func (s *Server) AppRun(
	...
	// TODO: порт захардкожен и не связан с config.yaml; при запуске двух сервисов на одном хосте
	// оба экземпляра попытаются поднять gRPC на одном и том же адресе.
	grpcAddr := ":50051"
	go func() {
