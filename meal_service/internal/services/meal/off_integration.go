...
import (
	...
	offutils "github.com/JoePeach762/PP_project/meal_service/internal/services/meal/off_utils"
)
...
func (c *HTTPClient) FetchProduct(ctx context.Context, name string) (*models.MealTemplate, error) {
	...
	if resp.StatusCode != http.StatusOK {
		return nil, fmt.Errorf("OpenFoodFacts вернул статус: %d", resp.StatusCode)
	}
